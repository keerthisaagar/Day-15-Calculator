...
let btplus = document.createElement("button");
...
let btmul = document.createElement("button");
...
let btclr = document.createElement("button");
...
let bteq = document.createElement("button");
...
let btdiv = document.createElement("button");
